...
package com.example.anoj.Activity.Helper;
...
public class ManagmentCart {
    ...
    public void insertFood(Foods item) {
        ...
        tinyDB.putListObject(FirebaseAuth.getInstance().getUid().toString(),listpop);
        Toast.makeText(context, "Added to your Cart", Toast.LENGTH_SHORT).show();
    }

    public ArrayList<Foods> getListCart() {
        return tinyDB.getListObject(FirebaseAuth.getInstance().getUid().toString());
    }
    ...
    public void minusNumberItem(ArrayList<Foods> listItem,int position,ChangeNumberItemsListener changeNumberItemsListener){
        ...
        tinyDB.putListObject(FirebaseAuth.getInstance().getUid().toString(),listItem);
